...
export default function FeaturedListings() {
  ...
  const featuredItems = [
    ...
    {
      id: 5,
      title: "Projector & Screen - 4K Ultra HD",
      category: "Electronics",
      price: 32.0,
      description: "Cinema-quality projector with 120-inch screen for home theater experience.",
      image: "/placeholder.svg?height=300&width=400",
      rating: 4.8,
      reviews: 23,
      sponsored: false,
    ...
    <section className="py-12 bg-white">
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex items-center justify-between mb-8">
          ...
          <Link href="/featured-listings" className="text-teal-600 hover:underline flex items-center">
            View all
        ...
        <div className="relative">
          ...
          >
            {featuredItems.map((item) => (
              <Card
                key={item.id}
                className="overflow-hidden hover:shadow-lg transition-shadow flex-shrink-0 w-full sm:w-[calc(50%-12px)] lg:w-[calc(33.333%-16px)] xl:w-[calc(25%-18px)] snap-start"
              >
                <div className="relative">
          ...
          <Button
            variant="outline"
            size="icon"
            className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-1/2 bg-white rounded-full shadow-md z-10 hidden md:flex"
            onClick={() => scroll("left")}
          ...
          <Button
            variant="outline"
            size="icon"
            className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-1/2 bg-white rounded-full shadow-md z-10 hidden md:flex"
