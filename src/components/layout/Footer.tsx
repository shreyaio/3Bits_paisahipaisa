    ...
    <footer className="bg-gray-100 py-12 border-t">
      <div className="container grid gap-8 grid-cols-1 md:grid-cols-4">
        <div className="space-y-4">
          ...
          <p className="text-gray-600 text-sm">
            Building trust in the sharing economy. Rent items you need, share items you own.
          </p>
        </div>
      ...
      <div className="container mt-8 pt-8 border-t border-gray-200">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm">© {new Date().getFullYear()} TrustShare. All rights reserved.</p>
